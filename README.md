...
download" checkbox, ticked by default, and the link builds a standard bookmarks file (the format
browsers import from their bookmark manager) from the ticked ones. They sit in a folder
